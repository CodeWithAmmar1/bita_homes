...
class DischargePressureSetting extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold( 
      backgroundColor: Get.isDarkMode ? ThemeColor().mode2 :ThemeColor().mode1, appBar: AppBar(
        backgroundColor: ThemeColor().actual,
        centerTitle: true,
        title: Text("Discharge Pressure Setting",style: TextStyle(color:  Get.isDarkMode ? ThemeColor().mode2 :ThemeColor().mode1,),),
