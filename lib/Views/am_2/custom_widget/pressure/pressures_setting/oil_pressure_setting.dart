  ...
  Widget build(BuildContext context) {
    return Scaffold(backgroundColor: Get.isDarkMode ? ThemeColor().mode2 :ThemeColor().mode1,
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("Oil Pressure Setting",style: TextStyle(color:  Get.isDarkMode ? ThemeColor().mode2 :ThemeColor().mode1,),),
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              Obx(
                () => Text(
                  "${_mqttController.psig3sethigh.value.toDouble().toStringAsFixed(0)} PSI",
                  style: TextStyle(
