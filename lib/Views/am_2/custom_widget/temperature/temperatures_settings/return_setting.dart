  ...
  Widget build(BuildContext context) {
    return Obx(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("Return Setting",style: TextStyle(color:  Get.isDarkMode ? ThemeColor().mode2 :ThemeColor().mode1,),),
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              Obx(
                () => Text(
                  "${_mqttController.temp1sethigh.value.toDouble().toStringAsFixed(0)}°C",
                  style: TextStyle(
        ...
        SliderTheme(
          ...
          child: Obx(
            () => Slider(
              value: _mqttController.temp1sethigh.value.toDouble(),
              min: 0,
              max: 100,
              divisions: 100,
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              Obx(
                () => Text(
                  "${_mqttController.temp1setlow.value.toDouble().toStringAsFixed(0)}°C",
                  style: TextStyle(
                    fontSize: Get.width * 0.04,
                    fontWeight: FontWeight.bold,
                     color:Get.isDarkMode ? Colors.white :Colors.black,
        ...
        SliderTheme(
          ...
          child: Obx(
            () => Slider(
              value: _mqttController.temp1setlow.value.toDouble(),
              min: 0,
              max: 100,
              divisions: 100,
              onChanged: (double value) {
